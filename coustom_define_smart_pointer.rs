...
/*
enum List {
   Cons(i32, Option<Box<List>>),   //ye wala code hm nay is wja say liya hai jo upar wlay code main hm nil 
   //use kr rhy thy wo extra momory lay rha tha heap pr to us extra memory ko hm nay overcome kiya hai yha 
 }
    ...
    */
    ...
    impl Drop for MySmartPointer{
     ...
     fn main() {
        ...
        println!("{}", 50 == a);
        println!("{}", 50 == *b); 
        //println!("{}", a == b); //we cannot compare ref to value
