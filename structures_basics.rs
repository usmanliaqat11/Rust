...
fn main () {
    ...
    //all the structures we have created till now its immutable just like immutable variables.

    //Let us create a new immutable structure of person four and display some of its values.
